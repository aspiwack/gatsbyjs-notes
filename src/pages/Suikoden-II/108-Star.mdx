...
Pick up Resurrection Rune (Right side of first screen with chests).
...
##### Equipment
 ...
 - Luc: Bolt of Wrath > Eilie (l X)
 - Luc: Remove Medicine (X2)
 - Nanami: Sacrificial Jizo
...
##### Nanami's Equipment
 - Feathered Cap
 - Wakaba's Karate Uniform (l d X)
 - Top accessory > Wakaba's Skill Ring (l u X)
...
##### Army Formation
 ...
 - **Adlai** > Gilbert
 - **Miklotov** (Viktor) > Gilbert (if he doesn't have Cavalry already).
 - **Chaco / Knight** > Luc
 - **Jeane** > Hero
...
### Ryube Forest
If not saving in Banner Village stay at inn here.
...
Teleport to Radat (4U), head to Banner Village.

### Radat > Banner Village
Optionally go to inn to Stay and Save. You can then Soft Reset for Rose Brooch.
...
##### Buy
 ...
 - 4 Escape Talisman
 - 0-2 Sacrificial Jizo, attach to Nanami so she'll have 1-2.
...
### Rokkaku
Recruit **Mondo**, Option 1. Replace Amada or Nanami, Amada if worried about Kindness points.
Recruit **Sasuke**.
...
##### Equipment
 - Mondo: Ninja Suit > Riou (l)
 - Mondo: Shredding > Riou (r[2])
 - [OPTIONAL] Mondo: Jizo > Nanami (r[2] u2)
 - Kasumi: Remove Ninja Suit
 - Kasumi: Remove Speed Ring
 - Kasumi: Remove Bolt of Wrath
 - Kasumi: Winged Boots > Riou (r[2] d)
...
Luc Shredding, can use Nanami Charm Arrow or Hero attack for Spark if Luc is too slow.
Can also kill off Meg here if needed. If so, heal Luc with Flik Mega Medicine.
...
> If no Rose Brooch & are on pace for Meg Kindness can go to Banner here (→↓5)
...
##### Turn 2 (assumes Violenced)
 - Hero: Shift / Defend
 - Luc: Take from Bag - Shredding x4
 - Meg Trick Rune
...
> If no Rose Brooch go to Banner here (r d5)
...
#### 1st Soldier Battle
 - Mazus: King's Road
 - Meg: Attack Commander
 - Luc: Take from Bag - Shredding x4 if you didn't earlier / Defend
 - Hero: Attack front middle (spear guy)

Next 4 battles Luc uses Shredding.
Next 3 battles Luc uses Shredding scrolls. Important that he has 1 left for Beast Rune.
...
##### Turn 3
 - Flik: Attack Left Head (just in case of rare range)
 - Meg: Attack Left Head
 - Hero: Attack Left Head
