...
After scene go south to next screen, west then south across bridge and west to rune shop. Exit rune shop.
...
##### Sell
 * Sacrificial Jizo
 * From bottom, everything above Breath of Ice S1 until Breath of Ice S3
 * Hero: All Accessories
 * Lyon: All Accessories (can skip Antitoxin)
 * Georg: Everything
 * Sialeeds: Everything
...
> This is for Speed for ambush rate, should be impossible to get ambushed with this setup.
##### Swap
 * Sialeeds > Entourage
...
After leaving Sewers, **before fight**, swap Shoon for Sialeeds.
...
Dangerous Man: "How many times do you have to get in our way before you're satisfied?!" Option 1
...
> If you want a safer Cius & Lelei, you can pick the Jizo by the Rune Shop.
...
If you haven't already,  floor, pick up **Prosperity Ring**.
...
This prevents ambushes in mines before Gunde joins/after Gunde leaves.
##### Swap
 * Logg: Entourage
 * Lun: Entourage
...
### Dwarf Camp
**Buy Jizos**. Can buy up to 3, need to have 900 left after purchases.
Go northwest.
...
##### Swap
 * Lun: Party (This needs to be done first! Want Logg in backrow)
 * Logg: Party
...
### Rainwall
Go to Salum's Manse. Go to your room.
Go to Oboro's ship.
...
##### Setup
 * Sialeeds: Remove Sialeeds, Lelei. Add Kisara (1D), Lelei (X), Luserina (1D)
...
Dahak meeting room. After cutscene **talk to Raja or Lucretia to unlock Yashuna.**
...
##### Attach
 * Lightning: Lyon
 * Lightning: Kyle RH, over Water Rune
...
### Yashuna Village
Head southwest from boat to pick up **Arrow Stance**.
Back west across stairs then across south stairs and go straight to exit.

### World Map
First battle you get, switch to Arrow Stance.
...
##### Equip
 * Jizos onto Hero (Over Berserk Blow Scroll), Kyle, Lyon in that order if short)
 * Berserk Blow Scroll: Zweig

</Menu>

#### Diamond Sun A (3900HP) & Diamond Sun B (4500HP)
> Can 3T kill with normal MP and 2 Berserk Blow Scrolls for Zweig.
> T1 is standard, if no stun then Hero & Zweig Berserk Blow Sun **B**, rest standard.
> T3 All use best remaining Magic, should barely kill.
...
##### Unequip
All Jizos. Can leave one on Kyle for Zahhak later.
...
##### Strategy
![Hatred Fortress Siege](../../images/Suikoden/V-any/HatredFortressSiege.png)

 1. **Dahak**: Directly down, use dark spot in water as marker (1 above it or on it / below)
 2. **(R1) Hero**: Go to indicated position (left side of white water, 1 above right boat)
 3. While waiting, use R1 to cycle to Goesch. This will make next R1 go to Dahak.
 4. **Hero**: Once you stop moving, move 2 down 2 right. Once in range of both ships Dawn rune. Top right ship turning and moving towards you a bit is a good indicator.
 5. **Dahak**: After Dawn Rune, Barrage bottom left ship as soon as in range.
 6. **(R1) Dahak**: Barrage other ship.
...
### Ceras Lake Castle
Zweig: "Headquarters?" 1m45s before textbox with Gizel, Alenia, Zahhak
...
##### Sell
 * Party Items: Everything but Escape Scroll, Jizos, Lightning Crystal, Water Crystal
 * Hero: Prosperity Ring
 * Zerase: Star Robe
 * Kyle: Everything except Lightning Amulet (Lightning Amulet if < 237415 Potch)
...
**Do this menu before leaving building!**
...
##### Setup
 * Logg: Remove All *Skippable, used for backup*
 * Kisara: Remove All
 * Cius: Remove All. Add Kisara (1D), Logg (X). *Logg is skippable*
...
Go back to Central Islet, then back to boat (2s faster than Blinking Mirror).
...
> This is for better preempt & ambush rate.
...
### Sable
Go to inn, rest, then head to Ranro Mountain.
...
##### Turn 1
 * Lyon: Soaring Bolt
 * Kisara: Furious Blow middle Column (1D)
 * Zerase: Star LVL4
...
Use **Escape Scroll** to exit Ranro Mountain.

**Blinking Mirror**, TP to **Sable (1U)**.
...
Sialeeds: "All right, here goes nothing!" 2m10s before battle start.
...
> All autohealed here.
> If money is tight can unequip Lightning Amulet.
 ...
 * Double-Edged: Goesch Left Hand (Bottom Slot)
 * Firefly: Georg
 * Crazed: Faylon Right Hand
 * Crazed: Goesch Right Hand

</Menu>

Talk to Combat Trainer.
...
##### Sell (Want 198500, 198000 if Runes done)
...
Costs 198000 for 3 LVL10
##### Sharpen (Up to select Goesch)
 * Goesch: 10
 * Faylon: 10
 * Dinn: 10
...
##### Sell
Sell everything but Escape Scroll

##### Buy
 * 4 Jizos: Goesch & Faylon
 * 2 Jizos: Dinn
...
| Opponent Dialogue                       | Opponent Action |
|-----------------------------------------|-----------------|
| All right, Prince. Show me how good...  | Guard           |
...
> Want Faylon to have at least 388ATK. If less, consider reverting to previous strat and adding a few people to tank hits and go True Men + Striking Arrow. If training Attack early, assume Goesch is higher, otherwise assume Faylon is higher.

##### Kyle's Party
 * [3/4D] Faylon / Goesch (Whoever has higher attack.)
...
##### Turn 1
 - **Switch Formation to Arrow Stance**
 - Roy: Defend
 - Zerase: Meteor
 - Lorelai: Soaring Bolt
 - Bernadette: Soaring Bolt **(NOT SILENT LAKE)**
 - Kisara: Soaring Bolt
...
#### Zahhak 2500HP 5 Elite Soldier 1200HP
##### Turn 1
**Twin Slash**
...
> If still alive, use True Men again. He has a very high chance of Parrying and if you lose it's game over.
...
Go to infirmary. Go to tablet room.
...
Go southeast to go outside for Galleon cutscene, Galleon to party.
...
### Sauronix Castle
Enter Castle. After cutscene talk to Combat Trainer.

<Menu>

##### Train
 - **Dinn**, **Cathari**, **Faylon**: Attack - C
...
### Twilight Forest Ruins
 ...
 4. Go east then north at forks.
 5. Cutscene next screen. Pick up top chest for **Fujiwara Gauntlets**.
 6. East at fork, then north at fork.
 7. **Pick chest for Golden Hammer**. West at fork.
 8. East at fork then north at fork (savepoint).

Zweig: "Give it a try, Prince." 45s no input.

#### Ancient Creeper 5000HP
> True Men does about 2750. Striking Arrow does ~330 less, want True Men to hit for ~2670 minimium.
True Men, Striking Arrow.
...
##### Party (All to entourage)
 * [2U] Goesch: Entourage
 * [1D] Cathari: Entourage
 * [3D] Faylon: Entourage
 * [3D] Galleon: Entourage

</Menu>

Go to infirmary. Go to War Room.
Exit War Room.
Go to 1st floor, TP **Dwarf Camp (3D)**.

### Dwarf Camp
Talk to Armor Shop owner.

<Menu>

##### Sell
Usual stuff. Want at least 171000 here.

</Menu>

Trigger scene with Wabon.

<Menu>

##### Swap
 * 4 people from party for fighters from entourage.

</Menu>

**Talk to Dongo**. Have to do it twice, sharpen weapon.
...
Go to Craig's Office, go all the way back downstairs.
...
##### Setup
 * Zerase: Remove All
 * Boz: Remove All, Add Zerase (2U), Talgeyl (X), Cathari (1R1D)
 * Goesch: Remove All
...
![Final Defense Campaign 1](../../images/Suikoden/V-any/FinalDefenseCampaign1.png)
 1. Move to P1
 2. At coastline (right side of cursor square), move to 1 tile left/right of Jidan.
 3. Fight Jidan, Mother Earth Rune.
 4. Instantly after battle Star Rune.
...
![Final Defense Campaign 2](../../images/Suikoden/V-any/FinalDefenseCampaign2.png)
 ...
 1. Move to P1 (directly down right, vertically aligned with Childerich)
 2. At red line, about 1-1.5 tiles left of Childerich go to tile 1 above 1 left of Childerich.
 3. When close to Childerich, target him or tiles below him.

### Castle
Northeast, enter castle from left side. Go to War Room.

**After Shula Valya and Castle cutscene only mash Triangle!**
**Somehow the war battle selection is completely lagless. I have now selected the wrong one twice.**

Raja: "We've got the upper hand now. I bet..." 3 Textboxes
*3 Lucretia Textboxes, then*
...
> Can optionally bring Wabon and Georg
> Wabon guarantees kill with non main damage dealer stun, with both 1 main damage dealer can get stunned and still kill.
...
![Stormfist Siege](../../images/Suikoden/V-any/StormfistSiege.png)
 ...
 2. [Shoon] When Cavalry gets close to Shoon, move 4-5 tiles southwest.
...
##### Sell
 * All Party Items EXCEPT Jizos, Blinking Rune Pcs, Crazed, and Firefly

##### Buy
 * 4 Jizos for all in party
 * Jizos to Party Items until 10
...
##### Equip
 * Double-Edged: Georg, Goesch, Dinn
 * Firefly: Galleon
...
##### Strategy
 ...
 3. [Hero]: Once Hero is standing on line on bridge, move to tile above Alenia (hard to click).
...
### Ashtwal Mountains
If you didn't pick it up in Doraat, pick up **Blinking Rune Pc**.
...
#### Gudalim 8500HP
> Want to hit 2190 Average minimum to kill with Striking Arrow T4

3 True Men, Striking Arrow or True Men
 ...
 * [] Faylon: Party
 * [] Galleon: Party
 * [] Goesch: Entourage (Skippable)
 * [1U] Wabon: Entourage

> You can skip bringing Goesch if you want, still 3T kill.
