...
In CTWs run, cursor stays on Kyle after unequip so he does All Best on Lyon first. This results in her getting a Defense Ring instead of Hero. Version difference?
...
Run northwest, talk to Item Shop owner to sell stuff.

<Menu>

##### Sell
 * From bottom, everything until Refined Clothes. Don't sell Refined Clothes (not sure why)
...
##### Equip
 * Breath of Ice x1 > Hero
 * Breath of Ice x3 > Lyon over Antitoxin (does this matter?)
...
Go to Royal Stands. After Lym and Miakis leave party run southeast then southwest to your seat.
...
> There is an armor shop on the way to exit, if you want to sell Belcoot's, Georg's, and or Belcoot's armor. Currently not routed in.

<Menu>

Anytime between Belcoot joins and first battle.

##### Swap
 * Belcoot & Sialeeds to Entourage
...
#### Thug x5 300HP
Auto, can do manual attacks for better targeting.
...
Arshtat: "But even if it is the truth...", Sialeeds: "Arshtat!" **Option 2**Arshtat: "I'll do to Stormfist what I did to Lordlake!" Option 1
...
##### Equip
 * Berserk Blow S3: Lyon
 * Dancing Flames S3: Hero
...
Pick up **Jewel Necklace**, **Defense Ring** by Oracle's Conclave then enter Oracle's Conclave.
...
> You CAN Swap Sialeeds & Lyon out to reduce party for Assassin.
...
> Swap to remove Lyon & Sialeeds: ~4s
Swap should be about 12s faster unless all really low.

#### Dolph & Childerich
Defend till dead. Auto if about to die and Lyon is dead (she's faster than them.)
If solo Prince just Auto.
...
Go to 2nd floor bottom right room.

> 2m35s after fadeout when Luserina leaves.
...
### Baska Mines
Pick **Turtle Orb**, chest closest to Beaver.

<Menu>

##### Heal
Heal Hero and Lyon if needed.
...
You want to kill 3 bats or 3 snails with Hero Dancing Flames scroll on middle one. Also want to stay healed up incase of bats.

**Watch party's MP after level up.**
You want 1 LVL2 on Lun and 3 LVL2 on Hero.

If Lun is short, give her Magic on top skill.
Adjustments can also be made in equipment menu if short.
...
##### Items (can use Logg Kindness Drops if only 2 needed)
 * Heal Hero, Lyon, Lun

##### Equip
 * Guard Ring: Hero (over Dancing Flames)
 * Military Uniform: Lyon
 * Sacrificial Jizo: Lyon over Berserk Blow
 * Sacrificial Jizo: Hero (over Medicine / Defense Ring)
 * (If only 2 LVL2 MP on Hero) Berserk Blow S1: Hero (over Medicine / Defense Ring)
 * (If no LVL2 MP) Dancing Flames S2: Lun
...
> Don't kill crossbow until he kills Lun, he will always target her.
> Lun and Logg must die, Hero and Lyon must live.

##### Turn 1
 * Hero: Berserk Blow Cius (1)
 * Lyon: Breath of Ice Scroll
 * Logg: Attack (1)
 * Lun: Dancing Flames Cius (1)

##### Turn 2
 * Hero: Berserk Blow Lelei (2 / 1 if Cius dead)
 * Lyon: Breath of Ice Scroll
 * Logg: Attack / Heal if alive
 * Lun: Defend

##### Turn 3
 * Hero: Berserk Blow Crossbow (bottom)
 * Lyon: Breath of Ice Scroll

##### Turn 4
Auto / Formation Skill for heal if dangerous.

> On test playthrough, Hero had 160MGC and Lyon had 127MGC.
> This was with Jewel Necklace on Hero & D Magic.
 ...
 * Lelei
 * Cius
 * Lun (Why though? Money?)

##### Unequip
 * Jizos on Hero & Lyon if not popped.
...
##### Setup
 * Sialeeds: Remove Sialeeds, Lelei.
 * Sialeeds: Add Kisara, Lelei, Logg  (1D Xx3)
...
> Note: You can add party members before the meeting room but Kisara isn't available. How important is she? Saves a decent bit of backtracking if you can get Kyle now.

After cutscenes, go back into Dahak and talk to Luserina
...
Pick up 2 chests straight below Rune Shop for **Sacrificial Jizo** & **Mega Medicine**.
Go to Rune Shop.
...
Talk to Logg, **Select Yashuna Village**.
**SKIP BOAT TRAVEL**
...
> Why no Guardian Boots on anyone or armor on Kyle?
> Any reason to do this menu here instead of before Suns?
 ...
 * Berserk Blow Scroll S1 onto Zweig if we have it.
...
##### Sell
 * Party Items: Everything but Escape Scroll, Jizos, Lightning Crystal
 * Hero: Prosperity Ring
 * Lyon: Guard Ring
 * Zerase: Star Robe
 * [If < 237415 Potch] Kyle: Lightning Amulet
...
Go downstairs. If you took damage, can heal with Kisara Great Blessing.
...
##### Sell
Sell from bottom until Titan Orb.
...
##### Swap
 * Miakis: Goesch
 * Zweig: Galleon (Maybe don't do this so Zweig has levels for Ashtwal mountains)
 * Lorelai: Cathari
...
### Sauronix Castle
> Chest outside castle is Dragonhorse Choker (+5ATK, 5k sell)

Enter Castle. After cutscenes exit castle, head into house in north east part of town. Pick up **Elementary Combat**.

Exit southeast, run back to Port Spinacks.
...
### Twilight Forest Ruins
 ...
 4. Pick up chest at fork for **Cape of Destiny**, then go east at fork.
 5. North at fork.
 6. Cutscene next screen. Pick both chests for **Guardian Gloves** & **Fujiwara Gauntlets**.
 7. East at fork, then north at fork.
 8. West at fork. (Both path's are same speed here, west is just easier to give directions for.)
 9. East at fork then north at fork (savepoint).
...
![Final Defense Campaign 1](../../images/Suikoden/V-any/FinalDefenseCampaign1.png)
 1. Hold directly down right to move to P1
...
![Armes Pursuit Battle 3](../../images/Suikoden/V-any/ArmesPursuitBattle3.png)
 ...
 4. When the archer turns, move to P1 in 3rd image.
...
##### Buy
 * 4 Jizos for all in party (3 Prince, seems excessive)
 * Jizos to Party Items until 40(!) in inventory.
...
##### Use > Georg's Combat Teacher
 * Dinn, Cathari, Faylon, Goesch: Attack - A
