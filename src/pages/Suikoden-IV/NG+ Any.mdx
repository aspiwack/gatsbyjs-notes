...
##### Equipment
 - **Snowe**: Best Equip
 - **Lazlo**: Best Equip, 2x Speedring > Power Ring
...
#### Duel: Glen
Do Special unless one of these, then Guard.
...
Textbox > **Option 2** > Mash > **Option 2** > Mash

<Menu>

##### Equipment
 - **Keneth**: Best Equip, 1 Power Ring
 - **Tal**: Ogre Gear, 2 Power Ring, *need to do manually*
...
##### Attach
 - **Double-Strike** > Lazlo, Snowe, Tal
 - **Rage** > Keneth

</Menu>

**Ship** > Textbox > **Option 2** > Mash

### World Map
Must level up to 5
Kill 3 Battles > 1 Textbox > **Option 2** > Mash

### Razril
Talk to Knight by Ship > Mash
...
#### Damp Hairball
Auto or Lazlo Attack rest Defend (Auto battle takes 2 turns)

Go back to Razril

### Razril
Mash > **Hall of Knights** > Mash x3
Leave Hall of Knights > Cutscene > Enter & Exit & Enter Hall of Knights > Mash X
**Audience Chamber** > Talk to Ramada > Mash

### World Map
Head east (to avoid re-entering Razril) > 67.5° > Cutscene > Mash > Cutscene
...
After Battle 3 Cutscene > Mash > Cutscene x6 > Mash

**Roof of Hall of Knights Hallway** > Cutscene x4
Rune of Punishment > Cutscene > Mash
Cutscene x2 > Option 1 > Cutscene x3 > Mash > Cutscene > Mash
...
##### Equipment
 - **Chiepoo**: Best + Power Ring

</Menu>

Fight 2 Battles
(Alternate Cutscene / Mash) x3 / Cutscene

Talk to Troy > Cutscene
**Cabin** > Talk to Colton > Option 1
Exit Cabin > Cutscene x2 > Mash > Cutscene
...
### Deserted Island
Talk to all companions twice > Mash
...
Go to cave last screen > (Mash 3rd time then) Cutscene > Escape Talisman
Talk to Keneth, Tal, Chiepoo
**Camp Area** > **Option 2** > Mash

Cutscene > Talk to Tal and Keneth > Cutscene
Go to Crab > Cutscene
...
Talk to Companions
Cutscene x2 > Mash Option 1 > Cutscene
...
**Palace** > Talk to Setsu > Mash > Cutscene x4 > Mash
Leave the palace > Mash > Cutscene
...
> Review this, can probably replace Tov and Tal with Kenneth in underlings.

 - **Lazlo**: *Rune Cannon* - Chiepoo, Tov. *Fighters* - Tal
...
Mash > Cutscene x3 > Mash > Cutscene > Mash

Return to Obel

### Obel
Talk to innkeeper > Cutscene
Talk to NPC by Stairs and head to HQ
Cutscene first 3 screen transitions > Text box next 2
Talk to Louise > Mash
Talk to Desmond. ~3 textboxes, mash Triangle
...
### Nay
Take right path to Oleg > Talk to Oleg > Option 1 > Cutscene
Talk to innkeeper
Try to Exit room > Cutscene x3 > Mash
Go to sleep
Return to the camera > Cutscene x3 > Take right path
Return to port > go to the shore > Mash
Get back on Ship
...
### Obel
Talk to Lino in Palace > Cutscene
...
Cutscene x2 > Go to the palace > Mash
Leave Palace > Cutscene
Go back towards HQ > Cutscene x4
Option 1 > Cutscene x5

#### War Battle: Defending Obel
 - **Lazlo**: *Rune Cannon* - Chiepoo. *Underlings* - Remove at least 6 Underlings.

Start the battle

##### Turn 1
 - **Lazlo**: 1 Up 1 Left, Face Left
...
### Headquarters
Leave HQ > Cutscene
**War Room** > Cutscene x2
Leave HQ > Cutscene > Mash > Cutscene > **Obel**
...
Cutscene > Option 1 > Cutscene > Option 1 > Cutscene x11
...
Talk to Kika > Mash > Cutscene > Option 1 > Cutscene > Mash
...
Cutscene x2 > Mash > Cutscene > Mash
...
##### Turn 2
 ...
 - **Lazlo**: 1 Right 3 Up, Board

##### Board Battle Turn 1 & 2
 - **Lino / Hervey**: Defend
 - **Tal**: Attack 1
 - **Keneth**: Attack 2
...
Cutscene > 2 Option 1s then **Option 2** > Mash > Cutscene x2
...
Turbo > Cutscene > **Option 2** (little bit faster) > Turbo
...
##### Rune Shop
 - Double-Strike: Lazlo, Lino, Kika, Hervey
...
### Nay
Go to Chief’s house > Turbo > Option 1 > Turbo
...
### Razril
Cutscene > Turbo > Option 1 > Turbo > Mash
...
**Training Hall** > Cutscene x3 / Fight / Cutscene x2 / Turbo / Cutscene
**Boat in Razril Port** > Turbo
**Hallway** > Sleep in your room
Glowing Hand Mirror

### The Chicken
Teleport to Hermitage Island
...
### Nest of Pirates
Enter Bar
Cutscene / Mash / Turbo / Option 1 / Turbo / Cutscene / Turbo / Cutscene
Glowing Hand Mirror

### The Chicken
Teleport to Mordo Island
...
> Review, can we replace Chiepoo with someone with different element for counter?

 - **Lazlo**
   - *Captain*: Remove Lazlo
   - *Rune Cannon*: Add Jeane, Chiepoo
...
Cutscene / Mash / Cutscene x4 / Option 1
...
Cutscene x2 > Option 1 > Cutscene x5 > Mash > Cutscene > RoP > Cutscene
...
Tubo -> Option 1 > Textbox > Go to room > Sleep
Glowing Hand Mirror > Go to War Room
...
Cutscene x9 > Option 1 > Cutscene >  RoP > Cutscene x6 > Done!
