...
TP **Riverford**.
Complete quest (guy to the right) for **$15000** + **Revitalizing Jam**. Buy **Nourishing L** + **Tough Nut L** from guy near right exit.
 ...
 * Cyrus: Ignis Ardere x4
 * Tressa: Nothing (Attack) / Whatever needed if something bad happened.
 * Alfyn: Defend

##### Turn 4
 * __Pay attention to number of shields Steorra has left__
 * Tressa: Defend if before Cyrus / Donate BPx2 if after Cyrus
 * Alfyn: Revitalizing Jam Cyrus
 * Cyrus: Ignis Ardere x3 (12) or Tonitrus Canere x3 (8) or Ignis Ardere x3 (4)
 * Therion: Defend

##### Turn 5
 * __Pay attention to number of shields Steorra has left__
 * Cyrus: Tenebrae Operire x3 (4), Ignis Ardere x3 (6) or Tonitrus Canere x3 (2)
 * Tressa: Collect x4 / Defend if Donate BP last turn
 * Therion: Pom M Cyrus / Nothing if Donate BP last turn
 * Alfyn: Nothing
 ...
 * Cyrus: Ignis Ardere x4
 * Therion: L Stone
 * Alfyn: L Stone / Amputation x4 if Icicle or Injurious Dust + Curious T1
...
Joshua: Lux x3 + Peacock OR Lux x4 + Fire/Light M (other M Stones are range)
...
### Olberic Ch.4
> You need 2 Fire/Thunder Ls for 
 ...
 * Therion: **Starseer**, Ethereal Healing, **Starseer**
...
Buy **Battle-tested Staff** from bishop.
