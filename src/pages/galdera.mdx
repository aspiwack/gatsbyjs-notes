...
> Look to see if Cyrus is before Tressa T1 if you want to guarantee 78SP used.
> If he is, boost Elemental Break and have Therion Donate BPx3 and Cyrus Glacies x4
> If not, play the strat below.
...
##### Turn 3
 * Cyrus: Ignis Ardere x4 / Lightning Blast x3 if Ignis x4 T2
...
Archibold: Tenebrae x3 + Peacock OR Tenebrae x4 + Ice M (other M Stones don't kill)
