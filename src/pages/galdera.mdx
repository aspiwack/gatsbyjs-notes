...
TP __Riverford__.
Scrutinize (70%) & pick the __Fire L__, complete quest (guy to the right) for __$15000__ + __Revitalizing Jam__. Buy __Nourishing L & Tough Nut L__ from guy near right exit.
 ...
 * Ophilia: Heal More + Revive, **Warrior**, Spearhead, Thousand Spears
...
Enter **Duskbarrow**. Purchase Curious Antique from man near the shop. Chests: **Curious Antique **(red chest in the uppermost left-hand corner), **$30,000 **(purple chest in the center of town) Buy 1-2 Purifying Dust from shop. Sell gold items. Goal is $110,000
 ...
 * Therion: Defend / Pom M Cyrus
 * Alfyn: Soothing Dust + Curious Bloom / Peacock

##### Turn 2
 * Therion: Aelfics Cyrus
 * Cyrus: Glacies x3/4
 * Tressa: Donate BPx3 / Pom M|L / Defend
 * Alfyn: Peacock Strut Cyrus / Pom / L Stone / Nothing

##### Turn 3
 * Cyrus: Ignis Ardere x4
 * Tressa: 4xCollect / L Stone
 * Therion: L Stone
 * Alfyn: L Stone

> If you got the Collect and want a 3T Balogar, buy **Injurious Dust** from Zeph.
...
##### Turn 1
 * Cyrus: Elemental Break x2
 * Tressa/Therion: 1 Does HHM / Shackle Foe, other either heals or Pom M/L Cyrus
 ...
 * Tressa: Leghold Trap
 * Therion: Defend
 * Alfyn: Peacock Strut Cyrus if not done yet / Pom M/L/Jam Cyrus / Heal
 ...
 * _If skipping Collect on Balogar_
 * Tressa: **Scholar**, Lightning Blast + Alephan’s Enlightenment

##### Support Skills
 * Tressa: -Grow on Trees _or Snatch if not Collecting_, +Evasive Maneuvers
 ...
 * Cyrus: Ignis Ardere x4
 * Tressa/Therion: L Stone

---

#### 3T No Collect strat (requires Injurious Dust)

**You need 1 free turn somewhere to Pom M Cyrus. Replace someones action accordingly. Options are:**

 * __Tressa before Therion T1__: Tressa Pom M Therion, Therion Aelfics T1 Pom M Cyrus T2
 * __Therion before Cyrus T2__: Therion Pom M Cyrus T1
 * __Cyrus before Balogar T2__: Alfyn Peacock T1, Pom M T2. Saves an L Stone too?
 * __Anyone before Cyrus T3__: Tressa Pom M T2, Alfyn or Therion Pom M T3
 ...
 * Tressa: Sorcerer's Robe, -Empowering Bracelet +Empowering Necklace
 * Alfyn: Unequip All
...
Steal **Sharp M** from guy in Stonegard by entrance to Woods area.
 ...
 * Tressa: Unequip All
 * Therion: Enchanted Circlet, -Elemental Shield, -Empowering Necklace, +Mighty Belt
...
##### Support Skills
 * Primrose: +Persistence, Saving Grace, Hale & Hearty
