...
Pick **Revitalizing Jam** and optionally **$30000**.

<Menu>

Do this Menu right before Winnehild since you remove **Evasive Maneuvers**.
 ...
 * Cyrus: Tenebrae Operire
 * Tressa: Defend
 * Alfyn: Peacock (x2 if Elemental Break miss)
 ...
 * Therion: **Starseer**, 1 Skill, **Merchant**
 ...
 * Therion: Fortitude, Physical Prowess, BP Eater, Surpassing Power (Remove all, then start from bottom.)
