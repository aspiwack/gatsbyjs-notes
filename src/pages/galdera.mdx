...
TP **Noblecourt**. Trigger the cutscene inside the bar for Therion 2. Guide **Aspiring Actor**, on the stairs near the cemetery. Optionally purchase **Pom Mx2** from man in the cemetery. Finish sidequest: In Search of Father (I) (Talk to Kit)
 ...
 * Tressa: **Merchant**, any skill, **Apothecary**
...
TP __Riverford__.
Scrutinize (70%) & pick the __Fire L__, complete quest (guy to the right) for __$15000__ + __Revitalizing Jam__. Buy __Nourishing L__ from guy near right exit.
...
### Alfyn Ch.1
##### Item Shop
Buy 11 Noxroots?, Injurious Seed, Soothing Dust, Essence of Grape.
Unequip Ophilia
...
Optional: Pick **Pom L**. Kill 1 mob for JP

Can use the **Magic L** before Gideon. If not might want an Axe hit or 2 from Alfyn to guarantee kill.
...
Optional: Pick **Refreshing Jam **in Orlick’s Manse, red chest sitting out in the open at the end of the second screen. Can kill 1 mob for JP, do nut menu before Orlick.

<Menu>

##### Inventory
 * Cyrus: Magic L(s), Invigorating S, Invigorating M
 * Tressa: Resistant L
...
##### Equipment
Tressa: Sorcerer’s Robe, -Tempest Amulet +Empowring Bracelet
...
In **Shrine of the Warbringer** pick **Revitalizing Jam**.

#### Winnehild, Warbringer (216 SP)

> If stuff goes wrong can delay Peacock / Elemental Break.
> Just focus on setting up Aelfics / Leghold and breaking T2.

##### Turn 1
 * Cyrus: Glacies Claudere
 * Tressa: Leghold x2
 * Therion: Healing Grape (M) poisoned character or HHM / Shackle Foe if before Winnehild
 * Alfyn: Peacock x2
...
##### Turn 4
 * Cyrus: Elemental Break
 * Tressa: Revitalizing Jam
 * Therion: Defend
 * Alfyn: Injurious + Essence of Grape
...
Tressa: -Grow On Trees, +Boost Start
...
### H’aanit Ch.3
Alaic: Fox, 2 Shadow L, any L OR Fox, Shadow M, Shadow L, Thunder L
 ...
 * Alfyn: Double Tomahawk, Elemental Shield, Oasis Hat, High House Armor, Empowering Bracelet, Empowering Necklace
 ...
 * Olberic: Spearhead + Thousand Spears, **Merchant**, Rest + Trade Tempest, **Thief**, HP Thief + Shackle Foe + Armor Corrosive
