...
Enter **Duskbarrow**. Purchase Curious Antique from man near the shop. Chests: **Curious Antique **(red chest in the uppermost left-hand corner), **$30,000 **(purple chest in the center of town) Buy 1-2 Purifying Dust from shop. Sell all valuables, keep **Death Cleaver, Stimulating Bracelet, Giants Club **(Goal is $110,000)
...
Whenever you need to restore SP, use nuts.
...
Sell gold items, **Omar's Axe**, and **Wizard's Rod**. Goal is $60,000.
...
Pick **Revitalizing Jam.** Do this Menu right before Winnehild since you remove **Evasive Maneuvers**.
...
##### Turn 1
 * Cyrus: Elemental Break x2
 * Tressa/Therion: 1 Does HHM / Shackle Foe, other either heals or Pom M/L/Jams Cyrus
 * Alfyn: 2xPeacock OR Pom M/L/Jam OR Heal

##### Turn 2
 * Cyrus: Glacies Claudere (x2/3) if Pom L or Jam used.
 * Tressa: Leghold Trap
 * Therion: Defend
 * Alfyn: Peacock Strut x2 Cyrus if not done yet / Pom M/L/Jam Cyrus / Heal
...
##### Turn 4
 * Alfyn: Pom / Jam Cyrus (needs 3BP and 72 SP)
 * Cyrus: Ignis Ardere x4
 * Tressa/Therion: L Stones
...
##### Support Skills
Tressa: -Grow On Trees, +Evasive Maneuvers
...
#### Alternate Riskier 2T Strat (Requires Essence of Pomegranate)
##### Turn 1
 * Cyrus: Elemental Break
 * Tressa: Defend
 * Therion: Defend
 * Alfyn: Soothing Dust + Essence of Pomegranate

##### Turn 2
 * Tressa: Alephans
 * Therion: Aelfics
 * Cyrus: Glacies Claudere x4
 * Alfyn: Icicle/Peacock if before Alfyn / Amputation x4 after
