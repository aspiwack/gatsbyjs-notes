...
##### Skill
 * Tressa: +Snatch
 * Therion: Evil Ward, The Show Goes On
...
> Can delay stuff done in Tavern but you skip the Pom L. You end up dead even on Poms
...
Whenever you need to restore SP, use nuts and do this menu. Should be done either here or before Orlick.
...
Steal **Fire L (80%)** from Tobias. *Quiz: Option 3, Option 3.* Steal **Light L, Shadow L (80%), and if possible Unerring Bracelet (65%)** from man to the left of the fountain in Stonegard Heights.
 ...
 * Tressa: -The Show Goes On, +Grow on Trees
...
> These are Tressa T1 or T2, Alfyn T1 or T2, and Therion T1
...
> If you want to guarantee 3T Balogar, teach Alfyn Extra Experience instead of Therion and teach Therion Boost-Start.
> Turn 1 have Tressa Pom M Cyrus. Rest of the fight is the same.
> You'll have enough JP after Balogar to teach Therion Extra Experience.
...
##### Support Skills
 * Tressa: -Snatch _or Grow on Trees if Collecting_, +Evasive Maneuvers
...
> If no free turns, have Cyrus Tenebrea 2x T3, And set him up for a 4x next turn. Can Rehabilitate Cyrus for extra safety. You won't need to break, should kill T4 or worst case T5.
...
> If you skipped Collect here & on Ogre Eagle, pick **$50000** chest.
...
##### Equipment
 * Therion: Optimize, +Mighty Belt (Battle-Tested Blade, Miguel’s Spear, Gideon’s Dagger, Death Cleaver, Master’s Longbow, Giants Club, -Captain's Badge +Mighty Belt)
