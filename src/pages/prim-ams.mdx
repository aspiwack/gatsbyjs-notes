...
Tressa: __Sidestep if not done already__
 ...
 * Tressa: __Warrior__, Incite + Thousand Spears, __Dancer__
 ...
 * Cyrus: Tomhawk + 2 Empowering Bracelet. Should have no other equipment.
 * Therion: Optimize
...
###### Turn 1
 * Primrose: 2xPeacock
 * Cyrus: Defend / __Axe__ if before Steal Items
...
#### Esmeralda [92sp]
###### Turn 1
 * Primrose: 2xPeacock / 2xEBreak if not Wind/Light Stones
 * Cyrus: Defend
 * Tressa: Defend
 * Therion: Pom L Prim

###### Turn 2
 * Primrose: Elemental Break / Peacock
 * Cyrus: 2xAxe / Any Wind or Light Stone
 * Tressa: 3xSpear / Nothing
 * Therion: Defend
