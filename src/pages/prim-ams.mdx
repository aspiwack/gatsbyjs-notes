...
TP __Rippletide__ and tag __Cobbleston__, get __$1500__ chest on the way.  Buy __11 of each herb__, and buy __Curious Bloom__ from the NPC by the exit.  
...
Enter __Marsalim__, buy __Invigorating M and Magic M__ from guy by entrance near shop. Go to palace, get 3 chests, scrutinize the right guard for a __Fire L__, pick __Tempest Amulet__, buy 2 __Pom M__ from left guard, pick __Fire L__.
...
##### Items  
 * <Cait cait={false}>1x Nourishing M Tressa</Cait>  
 * <Cait cait={true}>1x Nourishing S Tressa</Cait>  
 * All others to Prim

##### Jobs
 * Tressa: _Donate BP if JP > 230_, __Scholar__ + first 2 Scholar skills
 ...
 * Therion: Shackle Foe, __Dancer__ + Peacock Strut 


#### Hrodvitnir
###### Turn 1
 * Primrose: Defend
 * Tressa/Ophilia: Spear (has a low % chance of missing) 
 * Therion: 2x Sword
...
##### Item Shop
 * Buy 11 of each herb
 * Sell all gold items. <Cait cait={true}>Sell Death Cleaver.</Cait>

##### Item Shop
 * 6 Empowering Bracelets
 * Saintly Tiara for Tressa
 * 2 Charm Robe for Tressa
 * 3 Elemental Shields on Tressa/Ophilia<Cait cait={true}>/Primrose</Cait>.

### Ophilia Ch.3
TP __Goldshore__, pick __$4500__, scrutinize lady, pick __Pom M__, <Cait cait={false}>complete quest,</Cait> and get the __Wind L__.  
...
##### Equipment
 * Empowering Bracelet to all but Primrose
 * Therion: Charm Robe + Elemental Shield
...
##### Jobs
 * Ophilia: __Apothecary__, 3 Apoc Skills, Back to __Merchant__.
 * Tressa: __Apothecary__ (allows her to survive Mattias double hit)

##### Skills
 * Ophilia: Hale and Hearty
...
### Dreisang
TP __Atlasdam__. Steal __House Landar Records__ from bottom-left guy downstairs. Go to bottom-left side part of town to guide Whispermill guy. 

TP __Whispermill__. Buy __Nourishing L__ from blonde guy near shop, and complete quest to the top-right by windmill for __$22000__.

TP __Riverford__. Pick the __Fire L__, complete quest (guy to the right) foe __$15000__ + __Revitalizing Jam__. Buy __Nourishing L__ from guy near right exit.

TP __Saintsbridge__, talk to orange bubble NPC, buy River Blossom from child, talk to kid above to complete quest for __Badge of Friendship__.
 ...
 * Therion: __Merchant__, Donate BP + HH

##### Equipment
 * Tressa: Tempest Amulet + Friendship Badge
 * Primrose: Wind Amulet + Empowering Bracelet (__Unequip Elemental Shield if Therion is level 22)__
 * Therion: Tempest Amulet + __Elemental Shield__ (if level 22)
 ...
 * Primrose: Defend/ Pom L Therion (if after Therion)/Healing Grape M
 * Tressa: Pom M Self
 * Therion: HHV x4

###### Turn 3
 * Primrose: Pom L Therion if she defended last turn/Grape M/Soulstone L
 * Ophilia: Grape M/Soulstone M/L (if grape M already used)
 * Tressa: HHVx3
 * Therion: HHVx4
 ...
 * Ophilia: Soulstone M/L if not used earlier
 * Tressa/Therion: HHVx3

> If you don’t have Lightning Blast SP, use a Soulstone L or M instead.

### Prim Ch.2
TP __Stillsnow__. Unequip and replace __Ophilia__ with __Cyrus__ in the tavern interface before alluring.

##### Jobs
 * Primrose: __Sorcerer__, Tornitus + Elemental Break
 * Cyrus: __Dancer__, Peacock Strut
 * Tressa: __Scholar__, 2 skills
...
Use __Magic L__ whenever you have to heal SP in the menu before Gideon. TP __Quarrycrest__.
...
Leave town after finishing and re-enter to start Cyrus 2.

### Cyrus Ch.2
> If you don’t have a spare __Thunder L__, you’ll need to buy one from the merchant on the stairs, or use the __Shadow L__ later on in Chapter 3 (and purchase a __Shadow L__ in __Everhold__ during Prim 4).

Pick __Wind M__ from Odette’s house.

_Optional: pick Pom L in sewers_
...
#### Therion Ch.2
Steal __Invigorating M + Pom S__ from blonde guy near Tavern before stealing from second guy. Use the __Invigorating M__ on Prim whenever you have to heal SP.
...
##### Skills
 * Primrose: Peacock + Mole, Show Must Go On
 ...
 * Tressa: Defend/Spear
 * Alfyn: Defend
 * Therion: Donate BPx3/Defend

###### Turn 3
 * Primrose: Ignis x4
 * Alfyn/Tressa: Break with Axe/Spear
...
##### Jobs
 * Primrose: __Warrior__, All Warrior Skills, __Sorcerer__ + Surpassing Power
 * Tressa: All Scholar Skills
 * Therion: __Cleric__, All Cleric Skills
...
After inquiring the man at the tavern, you can TP to __Riverford__ (or to __Everhold__ if doing early Simeon)
 ...
 * Primrose: Elemental Break
 * Alfyn: Peacock Prim
 * Tressa: Defend/Soulstone M if before Prim
...
#### Simeon 1 [56sp]
###### Turn 1
 * Primrose: Defend/Peacock Strut Self/Grape Bunch
 * Alfyn: Dagger x2 Simeon
 * Tressa: HHM/Grape Bunch/Grape
 * Therion: Shackle Foe/Grape Bunch/Heal More/Grape M

###### Turn 2
 * Primrose: Elemental Break
 * Alfyn: Peacock Strut/Heal
...
###### Turn 1
 * Primrose: Defend
 * Alfyn: Heal Status/HP/Icicle
 * Tressa: Icy Wind
 * Therion: Status Heal/Pom M Primrose

###### Turn 2
 * Primrose: Glacies
 * Alfyn: Peacock/Heal/Pom M Primrose
 * Tressa/Therion: Defend

###### Turn 3
 * Primrose: Ignis x4
 * Alfyn: Concoct (curious bloom + smoothing dust)
 * Tressa/Therion: Alephan/Aelfric

###### Turn 4
 * Primrose: Glacies x3 \
 * Any: Soulstone M + L
 * _If prim is after others, you can optionally give her a Pom S/BP Donate to save an L soulstone_
 ...
 * Tressa: Icy Wind
 * Therion/Alfyn: Pom M Prim/Nothing/Status Heal
...
#### If Alfyn before Eagle on T2
###### Turn 1
 * Primrose: Glacies
 * Tressa/Therion: Status Heal/Nothing
 * Alfyn: Peacock x2
...
##### Skills
 * Primrose: Ventus + Lux, Elemental Aid + Stronger Strikes over Show Must Go On
...
Ignis first encounter, Glacies x2 Gaston
...
_Steal a **Thunder L** near Challenge 2 if needed_
 ...
 * Therion: Aelfric
 * Primrose: Tornitusx3
 * Any: Soulstone L + M (damage range)

__Erhardt__ HHV, HHVx3

#### Olberic Ch.4
If you don’t have a Pom M left, steal from the right guard at the entrance.  
...
##### Jobs
 * Olberic: __Dancer__, Peacock
 * Tressa: Sidestep
 * Primrose: Show Must Go On over Stronger Strikes

#### Werner [144sp]
###### Turn 1
 * Primrose: Defend
 * Tressa: Lightning Blast
 * Therion: Defend/Heal Terror
 * Olberic: Peacock x2/Heal Terror

###### Turn 2
 * Primrose: Tonitrus
 * Tressa/Therion: Defend
 * Olberic: Peacock/Heal Terror/Nothing
...
After cutscene in church, TP __Victors Hollow__ and steal from blonde lady on left below stairs. TP back to __Northreach__.

Kill encounter with 2x Tornitus

Steal __Pom L__, then 8% steal (reset at tavern as needed)

Get __Double Tomahawk__ from Ogen.

##### Equipment
Cyrus: Optimize + 500HP x2 + Tomahawk (stay as Apothecary, he can survive Darius double hit if he doesn’t crit)
...
###### Turn 1
 * Tressa: HHM
 * Therion: Shackle Foe / Revive if someone died
 * Cyrus: Defend
...
#### Cyrus Ch.4
Lucia requires 2L + 1M, if you don’t have enough Poms, loot chest in second room before second cutscene inside the dungeon.  If you don’t have remaining grape bunches, use Heal More instead.

##### Jobs
 * Cyrus: __Hunter__, Leghold
 * Tressa: __Warrior__, Incite
 ...
 * Primrose: Elemental Break
 * Cyrus: Axex4 (Break)
 * Tressa: BP Donate Prim
 * Therion: Aelfric OR Defend if before Prim (to avoid additional EB animation)
...
Swap Tressa back to Scholar.  Steal a spare __Wind/Light soulstone__ if you don’t have any, in case Esmeralda uses Red Blade on Cyrus.

#### Esmeralda [92sp]
###### Turn 1
 * Primrose: Ventus/Heal
 * Cyrus: Defend
 * Tressa: Spear/Heal
 * Therion: Shackle Foe/Heal/Dagger

###### Turn 2
 * Primrose: Elemental Break
 * Cyrus: Axe/Any Wind/L Stone
 * Tressa/Therion: Defend
...
_If Esmeralda kills someone, break her and get Shackle Foe/HHM up to survive Five Strikes._
