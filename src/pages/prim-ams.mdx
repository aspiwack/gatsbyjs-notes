 ...
 * 3 Elemental Shields on __Tressa/Ophilia<Cait>/Primrose</Cait>__.
 ...
 * TressaL __Cleric__, 4 Skills, __back to Apothecary__
 ...
 * Tressa: __Cleric__, 4 Skills, __Dancer__, Peacock + Mole
 ...
 * Tressa: Evil Ward, The Show Must Go On
...
### Tressa Ch.3
After getting __Egbert's Shield__, TP to __Goldshore__ and start Alfyn Ch.2. 
Once you inquire the guy in the top part of town, TP back to __Victor's Hollow__.

<Menu>

##### Jobs
 * Alfyn: __Dancer__, Peacock + Mole
 * Tressa: __Cleric__, 4 Skills if not done already

##### Skills
 * Primrose: Peacock + Night Ode, Show Must Go On
 * Alfyn: Show Must Go On
 * Tressa: Evil Ward if not done already
...
Tressa: _Sidestep if not done already_
...
---
#### If Therion before Prim T2 & Adds die to Glacies x2
##### Turn 1
 * Primrose: Glacies x2
 ...
 * Tressa: _Sidestep if not done already_, __Cleric__
 ...
 * Tressa: Defend / Herb of Valor
 * Therion: Lightning Blast
...
##### Equipment
Cyrus: Optimize + 500HPx2 + Tomahawk (stay as Apothecary, he can survive Darius double hit if he doesn’t crit)
...
### Darius [92sp]
###### Turn 1
 * Tressa: HHM / Revive if someone died
 * Therion: Shackle Foe
 * Cyrus: Defend
 ...
 * Tressa: __Warrior__, Incite, _Spearhead, Thousand Spears_
...
#### Esmeralda [92sp]
###### Turn 1
 * Primrose: Ventus/Heal if Esmeralda Red Bladed Prim and has an attack left.
 * Cyrus: Defend
 * Tressa: Spear/Heal
...
###### Turn 2
 * Primrose: Elemental Break
 * Cyrus: Axe/ Any Wind/Light Stone
 * Tressa/Therion: Defend
