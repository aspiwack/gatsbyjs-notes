...
### Darius [92sp]
###### Turn 1
 * Primrose: 2xElemental Break / Defend if safe.
 * Cyrus: Defend
 * Tressa: HHM
 * Therion: Shackle Foe
...
###### Turn 2
 * Cyrus: Axex2
 * Primrose: Peacock / Elemental Break
 * Tressa: 2xDonate BP / Peacock
 * Therion: Defend
 ...
 * Tressa: __Warrior__, Incite, _Spearhead_

</Menu>

> Options 2, 2, 2

Lucia requires 1L + 1M Pom, if you don’t have enough Poms, loot chest in second room before second cutscene inside the dungeon.  If you don’t have remaining grape bunches, use Heal More instead.
...
#### Esmeralda [92sp]
###### Turn 1
 * Primrose: 2xElemental Break
 * Cyrus: Defend / Any Wind/Light Stone if Red Bladed
 * Tressa: Heal / Defend / Incite if Esme hasn't acted yet.
 * Therion: Shackle Foe/Heal/Dagger/Pom M Prim

###### Turn 2
 * Primrose: Peacock
 * Cyrus: Axe/ Any Wind/Light Stone
 * Tressa: 3xSpear / 2xDonate BP Prim
 * Therion: Defend
...
_If Esmeralda kills someone, break her and have Tressa Incite. Setup Alephans, At least 2 BP on Therion,
And Peacock/EBreak for T5. T4 Break with Rain of Arrows + 3x Sword. Other weaknesses are Fire, Lightning, Wind.
