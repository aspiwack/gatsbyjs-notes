...
TP __Atlasdam__.  
Steal __House Landar Records__ from bottom-left guy downstairs. Go to bottom-left side part of town to Allure (60%) Whispermill guy. Go to left of school and Scrutinize (60%) Sword of Sokrath guy.
</Cait>
...
Enter __Marsalim__, buy __Invigorating M, Magic M, Resistant M__ from guy by entrance near shop. Go to palace, get 3 chests, scrutinize the right guard for a __Fire L__, pick __Tempest Amulet__, buy 2 __Pom M__ from left guard, pick __Fire L__.<Cait> Instead of Scrutinizing you can buy __Fire L__ or just buy an extra L Stone.</Cait>

TP to __Stonegard__, go to __West Everhold Pass__. Pick __Light L__ + __Pouch__, __Save & Reload__, enter __Everhold__. Buy __Sorcerer’s Robe__<Cait> and finish Sword of Swokrath quest</Cait>. Go back and __Save & Reload__, get __Pom M__, go to __West Everhold Tunnels__.
 ...
 * Tressa: _Donate BP_ if not learned already OR __Warrior__ + Incite + Thousand Spears, __Hunter__ + Arrowstorm
 ...
 * Tressa: __Warrior__ + Incite + Thousand Spears if not done already
...
_Steal **Mind-me-always** from flower girl before Challenge 2._
...
Steal __Pom L__, then 8% steal. When restoring reputation or after stealing, 
At the Tavern __unequip Olberic__ and swap for __Cyrus__.
 ...
 * Tressa: __Warrior__, Incite + Thousand Spears _+ Spearhead_ if not done already
 ...
 * Tressa: Donate BPx2 Primrose / Defend if Cyrus attacked
 * Therion: Defend

###### Turn 2
 * Cyrus: Axex2 / Pom M Primrose if Tressa broke.
 * Primrose: Elemental Break
 * Tressa: 2xSpear / 2xDonate BP / Nothing
 * Therion: Defend
