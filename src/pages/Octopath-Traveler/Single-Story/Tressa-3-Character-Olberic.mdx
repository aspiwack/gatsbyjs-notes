...
### Ch.2 Start
Buy **Thunder L** and **Thunder M**. Buy **Shadow M**. Pick **Fool's Gold Ore**. 
After last purchase TP **Cobbleston**.

### Olberic Ch.1
You can buy **Broadsword** from the guy before the dungeon to get Olberic 22 more speed.
 ...
 * Olberic: Defend x2?
 * Merchant 2: Knock off shield / Olive or something

##### Turn 2 and on
Setup Corrosive, break, and Vets x4 + Thunder M
...
Pick **Silver-filled Pouch**, purchase **Pom L**. Pick **Dazzling Artwork** and **$25000**.
TP **Victor's Hollow**.
...
### Tressa Ch.4
Sell Gold Items in shop. Need miminum $88000, should have about $98000.

Purchase **Wind L**. If you can't afford it or want to save the money for Dancers, pick **Wind L** in Sewers.

<Menu>

##### Equipment
 Therion: Remove Hasty Helm
 Olberic: Hasty Helm (Optimize if you got Broadsword)

</Menu>

> Writing ideal fight. If people die, can try to Olive and go for break T2 or T3. Need all alive at start of turn to win.
