...
Get scholar shrine (Flee from enccounter if you get it before scholar shrine - good luck!)
...
If you need to scrutnize the Tips and Tricks man, make sure you do it before triggering the cutscene where you do the first steal, or else he moves to the second screen.

Get the **Thunder L**, do the cutscene to your left, the tavern cutscene in the next screen.
Inside the tavern, Steal all **3 Soulstone M**.
...
Kill the encounter using either an M stone or Therion's Lightning Blast x2.
...
If you fail 5 scrutinizes, proceed with the story, restore reputation at the tavern, steal 2-3 Soulstones (Light M + Shadow M, can steal one more in case Gareth goes bad), and do the cutscenes before the steal.
...
Buy the **Empowering Bracelet** from the boy in the crowd before doing the first steal.
 ...
 * Tressa: Pom M Self OR Spear x2 if Therion got at least 5 hits of Thousand Spears
...
For the encounter before Gareth, kill them using Light M + HHB.
