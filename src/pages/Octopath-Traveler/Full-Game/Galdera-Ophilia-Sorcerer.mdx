...
Head east to the next screen. Buy & equip **Elemental Robe** from the weapon shop to Cyrus. Buy **Mighty Belt** and **Elemental Augmentor** from the old man at the end, then TP back to **Quarrycrest** and head to **Bolderfall**.
 ...
 * Cyrus: Empowering Bracelet x2
 * Tressa: Optimize, Unerring Bracelet
...
### Ophilia Ch.3
Pick **$4500**, pick **Pom M** and get the **Wind L**. 
...
M Stone + Lightning Blast x3 kills as well.

#### Northreach
> Watch money after purchases. If you have less than 28000$ you should probably sell the gold items here or in Goldshore. Otherwise you might not have enough for Vets for Mystery Dudes.
...
Head towards Duskbarrow. You can choose to S&Q, or YOLO. If you get battle better to kill it. Tree has just under 10k HP. The battle will set you up for EXP but you will be shorter on JP if you don't take the extra battle later.
...
You probably want to do this menu after killing the encounter in here so you have a Dancer.
 ...
 * Ophilia: Holy Light
 * Cyrus: Defend
 * Therion: Spear if Ophilia already did Holy Light, otherwise Spear to avoid 2nd break animation.
 ...
 * Cyrus: **Apothecary** (Speeds up some menus).
 * Therion: **Merchant**
...
> You can also do Attack x2 with Ophi instead of E Break & follow with 2 max boosted Sorc spells for a 72SP fight.
 ...
 * Therion: Optimize
 * Tressa: Remove Force Shield, +Elemental Robe
 ...
 * Cyrus: Optimize, Death Cleaver over Battle-Tested Axe, -Tempest Amulet +Empowering Necklace
