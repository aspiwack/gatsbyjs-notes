...
**West Grandport Coast** get **$20000**, and save/reload at save point.  Enter **Grandport**.

> The **Thunder L** here is now optional. If you get it, skip the **Fire L** purchase from Tobias in Stonegard and Steal it during Cyrus Ch.3. You essentially get a free L Stone and save 5.6k at the cost of some movement and risk of encounter.
...
Head east to the next screen. Buy **Fire L** from Tobias. Buy **Mighty Belt** and **Elemental Augmentor** from the old man at the end, then TP back to **Quarrycrest** and head to **Bolderfall**.
...
Get **Heavy Coin Pouch** in Deryl’s house. Kill encounter with Blizzard x2. Kill encounter in Murkwood with Thunder/Shadow L. If no tree Blizzard x3 kills too.
