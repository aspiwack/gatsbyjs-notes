...
Head east to the next screen. Buy **2 M Stones** from lady before screen transition. On the next screen buy **Fire L** and **Injurious Dust** from Tobias. Buy & equip **Elemental Robe** from the weapon shop to Cyrus. Go down the stairs and buy all **M Soulstones** from the guy guarding the first house.  Buy **Mighty Belt** and **Elemental Augmentor** from the old man at the end, then TP to **Cobbleston**.
...
##### Buy
 * **Adamantite Shield**, equip to **Ophilia**.
 * 11 Healing Grape M
 * 21 Inspiriting Plum
 * 11 **Herbs of Clamor**
...
##### Support Skills
 * Tressa: Grow on Trees, Heighten Senses
 * Ophilia: Hale & Hearty
...
You want to have at least **$108000** after shop, should normally have $116000.
...
TP to **Stillsnow** and head for **Northreach**. Kill encounter with 2xBandits + 3xIgnis/4xLightning Blast (or L Stone).
...
### Tressa Ch.2 Start
Steal **Curious Bloom (80%)** and **Injurious Dust** from man on the upper screen near the bar. Steal **Thunder M (100%) and L (65/80%)** from man near the stairs on lower screen. Pick **Fool's Gold Ore**.

> You can buy a Fire M or Light M off the 2nd guy for Venomtooth Tiger guaranteed Collect.

After the three purchases, TP **Noblecourt**.
 ...
 * Omar's Axe
 * Wizard's Rod
 * Tempest Amulets (optional, can be used for Galdera Phase 2)

</Menu>

Goal is $60,000.

Buy **Edbert's Shield** and **Plate Shield** and TP **Noblecourt**.

> Plate Shield covers a really rare situation vs Winnehild where Therion could die to Poison & let's you keep Tempest Amulet on until after Steorra.
...
##### Inventory
 * Cyrus: Magic Lx2, Invigorating S (if picked up), Invigorating M, Sharp M
 * Tressa: Resistant L
...
_If you're going to level up off Vanessa fight_
##### Equipment
...
*If Stimulating Bracelet equip not done earlier*
##### Equipment
 * Cyrus: -Unerring Bracelet +Stimulating Bracelet
 * Therion: Optimize
...
Steal **Light L, Shadow L (80%)**, and optionally **Unerring Bracelet (65%)** from man to the left of the fountain in Stonegard Heights.
...
Optionally steal **Pom L** from Alphas. Challenge Alphas, use **Fire L or Shadow L** to complete sidequest: Daughter of the Dark God (I).
TP **Saintsbridge**.

### Alfyn Ch.3 Start
Pick **Pom M** after cutscene. Steal **Poms** from guy by screen transition.

Go to Tavern, trigger cutscene. After cutscene enter Tavern and swap **H'aanit** for **Tressa**.
...
Then, **enter church & purchase Battle-Tested Staff.**
 ...
 * _If not done earlier_
 * Therion: Optimize (Important)
...
##### Equipment
 * Cyrus: Knowledge Staff, -Force Shield, -Empowering Necklace +Stimulating Bracelet
 * Alfyn: Unequip All
 * Therion: **Remove Rune Knife**, Gareth's Helm, Force Shield
 * Tressa: Badge of Friendship, Adamantite Shield, Adamantite Hat
...
Purchase **Fortifying L** from Tim (child standing to the right of weapon shop).
...
Purchase **Battle-Tested Blade** from Erhardt (in the house from Olberic 3). Talk to Bale twice to complete sidequest: Back with Bale.
...
If you need to sell later, you can pick up Master's Longbow here to sell for 9.8k.
...
##### Jobs
 * H'aanit: Leghold Trap, **Dancer**, Peacock Strut + Panther Dance
...
> To skip H’aanit 4 & Prim 3 Battle & get LVL45 Therion he needs to be LVL41 369EXP after Dragon

Unless you got some big discounts, sell Lizardking Axe, Divine Blade, Rune Knife, Miguel's Spear, and all your Refreshing Jams a bit over 40k.
...
> To skip Prim 3 Battle & get LVL45 Therion he needs to be > LVL42 1173EXP after Rufus
...
### Primrose Ch.4
Buy/Steal (65%) **Sharp L** and **Crit L**.

> These are the last Nut you get in the run. Use them anytime you go into the inventory to heal.
 ...
 * Cyrus: Optimize, -Stimulating Braclet +Empowering Bracelet, Vendetta Coat
 * Tressa: Optimize (Sorc Robe)
...
##### Equipment
 * Cyrus: Battle-tested Axe, Elemental Robe, -Elemental Augmentor +Mental Belt
...
##### Equipment
 * H’aanit: _(All Optional)_ Tempest Amulet, Unerring Bracelet
 ...
 * Ophilia: _(All Optional)_ Tempest Amulet, Unerring Bracelet
 ...
 * H’aanit: **Warrior**, 2 Skills, **Merchant**, 4 Skills, **Dancer**
