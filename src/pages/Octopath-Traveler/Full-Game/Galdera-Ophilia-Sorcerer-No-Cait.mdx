...
Kill first Pirate with Defend, Bow, Tradewinds x3
...
Tag **Noblecourt**. Optionally scrutinize the **Thunder L (30%)** here for pickup later.
TP to **Rippletide**, tag **Cobbleston** and head towards **North Stonegard Pass**.

> Break encounter in North Stonegard Pass with 2xBandits and flee.
> If Cyrus first, use Firestorm + Defend > 3x Bow Bird.
...
### Therion Ch.1
Kill encounter in Ravus Manor with Bandits or M Stone.

> You don't have to kill it, but if you don't and Cyrus had exactly 130JP for Evasive Maneuvers Tressa will end up 1 JP short.
...
Enter **Marsalim**, buy **Invigorating M, Magic M, Resistant M** from guy by entrance near shop. Go to palace, buy 2 **Pom M** from left guard, optionally pick **Tempest Amulet**, purchase **Fire L, Wind L, Shadow L** from right guard. Pick **Enchanted Circlet, $25,000, High House Armor** in the three red chests in the room to the far right.
 ...
 * 2 Essence of Grape
 * 11 Injurious Seed
 * 1 Kite Shield (attach to Tressa)

> After buying Injurious Seeds, press left then up to get to Kite Shield.
...
If you get a battle, kill with Blizzard x2.
...
Get **Heavy Coin Pouch** in Deryl’s house. Kill encounter with Blizzard x2. Kill encounter in Murkwood with Shadow L. If no tree Blizzard x3 kills too.
 ...
 * 1 Charm Robe, equip to Alfyn
 * Sell Gold Items
 * Sell Tempest Amulet if you got it earlier
...
##### Learn Skills
 * _Optional_ Ophilia: Luminescence (good for 2-3 fights, costs 30JP)
...
##### Turn 2
 * Ophilia: Blizzard
 * Alfyn: HHVx3 (DO NOT x4, it makes Mattias a range)
 * Therion: Pom M Alfyn
 * Tressa: HHVx4
...
##### Equipment
 * Alfyn: Optimize, **Mighty Belt** (Charm Robe, Flying Helmet)
 * Therion: Badge of Friendship
 * Tressa: Empowering Bracelet x2

##### Jobs
 * Alfyn: Rest, **Warrior**, Thousand Spears
 ...
 * Alfyn: -Endless Items +Grow on Trees +Summon Strength
...
> At LVL23, Alfyn surviving an attack + spell is really close, likely a range in your favor. If possible heal him.
...
Do this next time you need to heal SP
##### Inventory
 * Ophilia: Invig M
 * Tressa: Nourishing L
...
##### Inventory
 * Use Nuts & Plums if you didn't earlier

##### Equipment
 * Ophilia: -Empowering Necklace +Unerring Bracelet
 * Alfyn: -Mighty Belt +Empowering Necklace
 * Therion: **-Empowering Bracelet**
 * Tressa: +Elemental Heavy Armor
...
> You can Collect Vanessa for 12k by having Therion Donate BP x1 T1, and having Alfyn Pom M Ophilia.
...
You can do this anytime before Yvon.
##### Inventory
 * Ophilia: Magic M
...
##### Support Skills
 * Alfyn: -Grow on Trees +Hard Worker
